  ...
  useEffect(() => {
    ...
    const newNodes = [
      {
        ...
        position: { x: 250, y: 0 },
        className: 'bg-primary/20 border-primary text-primary-foreground font-bold rounded-lg',
      },
    ];
    ...
    result.risks.slice(0, 3).forEach((risk, i) => {
      ...
      newNodes.push({
        ...
        className: 'bg-destructive/10 border-destructive text-destructive rounded',
      });
