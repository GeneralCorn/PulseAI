...
export default async function RunPage({ params }: RunPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col p-4 gap-4 overflow-hidden h-screen">
      {/* Top Bar */}
      <header className="flex items-center justify-between shrink-0 h-14 border-b border-border/40 pb-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold tracking-tight text-primary">
            Synthetic Pulse <span className="text-muted-foreground font-normal">/ Command Center</span>
          </h1>
        </div>
